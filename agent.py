...
MUST be an edit — not a read, not a search. Non-negotiable. Any edit beats zero.**
...
3. Minimal patch is third. Empty patches score worst.
4. Never finish with zero edits. Any edit — even a one-line placeholder — beats zero.
...
## Execution Protocol
Floor: 3+ tool calls with zero edits → next action must be an edit.
