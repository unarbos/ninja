...
# Pre-emptive deadline thresholds. Helpers in this file consult either of
# these constants when they need to know how much of the surrounding solve
# budget has been consumed:
#   (a) wall-clock elapsed >= WALL_CLOCK_PREEMPT_HARD_FLOOR_S — absolute floor;
#   (b) wall-clock elapsed >= WALL_CLOCK_BUDGET_SECONDS * WALL_CLOCK_PREEMPT_RATIO
#       — proportional ceiling for the same threshold.
# Kept as named constants so any future tuning happens in one place.
