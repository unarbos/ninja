...
# class within the same group — the 064670 footgun split(/\n+?\n+/) which
# fails on normal single-newline records. Narrow: only flags when BOTH halves
# reference \n and no other separator class is present.
            ...
            for line in added:
                ...
                for m in _PRINTF_CALL_RE.finditer(line):
                    ...
                    if specs and specs != arg_count:
                        ...
                        break
                if issues and issues[-1].startswith(fname + ": printf"):
                    break
