...
Before writing any code, first run find . -type f | head -60 then grep -r to find ALL files referencing the changed symbol.

Build a list of ALL files needing changes and edit EVERY file in your list. An incomplete multi-file patch scores lower.
