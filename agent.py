#!/usr/bin/env python3
# CL-GPT-v11: churn firewall + issue simplification for retry
"""
...
def _solve_with_safety_net(**kwargs: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        # v11: simplify issue for retry
        _issue_for_retry = _simplify_issue_for_retry(kwargs.get("issue", ""), []) if not _patch1.strip() else kwargs.get("issue", "")
        _kwargs2 = {**kwargs, "issue": _issue_for_retry}
...
def _solve_attempt(**kwargs: Any) -> Dict[str, Any]:
    ...
    def maybe_queue_refinement(assistant_text: str) -> bool:
        ...
        # v11: churn firewall  -- flag out-of-scope file edits before self-check
