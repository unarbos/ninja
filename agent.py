...
def _solve_attempt(**kwargs: Any) -> Dict[str, Any]:
    ...
    def maybe_queue_refinement(assistant_text: str) -> bool:
        ...
        # Surfacing unaddressed bullets first is cheaper than relying on self-check.
        ...
        # Companion-test execution gate: only refinement signal backed by a real runner.
        # If any edited file has a partner test that actually fails, surface the
        # failure tail to the model as one fix turn.
