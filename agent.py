...
Task instructions may be in any language. Always respond in English and write code/patches in English.
Three anchors that are always in English regardless of task language:
- The acceptance criteria list — find and fulfill each bullet as a required deliverable
- File paths in backtick spans — these are always English: `path/to/file.ext`
- Symbol and variable names in code blocks — always English identifiers

Extract intent from the task, apply standard coding protocol.
"""
