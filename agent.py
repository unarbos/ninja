...
MAX_OBSERVATION_CHARS = int(os.environ.get("AGENT_MAX_OBSERVATION_CHARS", "16000"))  # 15Y: bigger observation window -> fewer follow-up reads -> fewer turns -> avoid 300s docker kill
MAX_TOTAL_LOG_CHARS = int(os.environ.get("AGENT_MAX_TOTAL_LOG_CHARS", "260000"))  # 15Y: keep richer rolling log
MAX_CONVERSATION_CHARS = 80000
MAX_PRELOADED_CONTEXT_CHARS = 48000  # 15Y: more upfront context -> fewer search turns
MAX_PRELOADED_FILES = 16  # 15Y: broader initial file picture
...
MAX_STEP_RETRIES = 2
WALL_CLOCK_BUDGET_SECONDS = 255.0  # 15Z: match king140s safety-net margin (300-255=45s) so multishot attempt2 can write partial patch to disk before SIGKILL. Bigger context budgets reduce turns so the lost 30s doesnt cost as much.
