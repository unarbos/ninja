...
_DATA_FIXTURE_TOKENS = frozenset({"fixture", "fixtures", "factory", "factories", "mock", "mocks"})
_DATA_FIXTURE_ISSUE_HINTS = frozenset({"fixture", "fixtures", "mock", "mocks", "data", "factory", "factories"})
